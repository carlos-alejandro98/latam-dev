...
const AppHeaderComponent: React.FC<AppHeaderProps> = ({
  ...
  const headerHeight = (isTablet ? HEADER_HEIGHT_TABLET : HEADER_HEIGHT_MOBILE) + insets.top;
  const gradientStyle = isTablet ? styles.gradientTablet : styles.gradientMobile;
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        ...
        style={[styles.gradient, gradientStyle, { height: headerHeight, paddingTop: insets.top }]}
      >
        <View style={styles.content}>
          <View style={styles.leftSection}>
            {showMenu ? (
              ...
              >
                <MenuOutlined size={menuIconSize} color={HEADER_COLORS.iconDefault} />
              </Pressable>
            ) : null}

            <View style={isTablet ? styles.nativeTabletBrandGroup : styles.nativeMobileBrandGroup}>
